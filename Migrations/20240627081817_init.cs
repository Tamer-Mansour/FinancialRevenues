        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ValueInJOD = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    PayerSSN = table.Column<string>(type: "longtext", nullable: false),
                    ...
                    CreatorUserFkId = table.Column<long>(type: "bigint", nullable: true),
                    DeleterUserFkId = table.Column<long>(type: "bigint", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Revenues_AspNetUsers_CreatorUserFkId",
                        column: x => x.CreatorUserFkId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Revenues_AspNetUsers_DeleterUserFkId",
                        column: x => x.DeleterUserFkId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Revenues_Governorates_GovernorateId",
                        column: x => x.GovernorateId,
                        principalTable: "Governorates",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Revenues_CreatorUserFkId",
                table: "Revenues",
                column: "CreatorUserFkId");

            migrationBuilder.CreateIndex(
                name: "IX_Revenues_DeleterUserFkId",
                table: "Revenues",
                column: "DeleterUserFkId");

            migrationBuilder.CreateIndex(
                name: "IX_Revenues_GovernorateId",
                table: "Revenues",
                column: "GovernorateId");
